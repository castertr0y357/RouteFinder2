# RouteFinder2 Project Rules & Skills

This file defines the rules and skills for the RouteFinder2 workspace.
...
*   **Upfront Plan Alignment & Ambiguity Resolution**:
    - For any non-trivial tasks (e.g., changes affecting database schemas, API routes, or multi-component UI states), draft an `implementation_plan.md` first. Propose the change to the user and obtain their explicit feedback/approval before executing.
